...
dfm1<-build_dfm(review_dat$text,
                 ngrams=1,
                 min.prop=0,
                 stop.words = FALSE)
...
dfm3<-build_dfm(review_dat$text,ngrams=1) %>%
...
review_dat_dfm_train<-build_dfm(review_dat_train$text,ngrams=1)

review_dat_dfm_test<-build_dfm(review_dat_test$text,ngrams=1) %>%
